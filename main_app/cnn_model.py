...
class CNN():
    def __init__(self, image_size=(128,128,3), nb_classes=2, nb_filters=32, kernel_size=(3,3), pool_size=(2,2)):
        ...
        print('Using Input_shape = ', self.input_shape)
        self.architecture()
    ...
    def architecture(self):
        ...
        self.model.add(Conv2D(self.nb_filters,(self.kernel_size[0], self.kernel_size[1]))) #2nd conv. layer (keep layer)
        ...
        self.model.compile(loss=loss, optimizer='adadelta', metrics=['accuracy'])
    ...
    def fit_generator(self, train_generator, validation_generator, n_samples,n_validation, nb_epoch=10, batch_size=50):
